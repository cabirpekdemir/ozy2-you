...
TIERS: dict = {
    ...
    "professional": {
        ...
        "icon":        "💼",
        "color":       "#0ea5e9",
        "description": "Developer & professional tools",
        "price_usd":   9.99,
        "features": [
            "chat", "home", "tasks", "memory", "briefing",
            "notes", "reminders", "books", "settings",
            "gmail", "calendar", "telegram",
            "github", "drive", "notion", "obsidian", "trello",
            "workspace", "plans", "projects", "lesson", "debate",
        ],
    },
    "social": {
        "name":        "OZY Social",
        "icon":        "🌐",
        "color":       "#10b981",
        "description": "Creative, social & lifestyle features",
        "price_usd":   9.99,
        "features": [
            "chat", "home", "tasks", "memory", "briefing",
            "notes", "reminders", "books", "settings",
            "gmail", "calendar", "telegram",
            "youtube", "content", "smarthome", "stocks", "whatsapp",
        ],
    },
    "full": {
        "name":        "OZY Full",
        ...
        "price_usd":   19.99,
        "features":    None,  # None = all panels unlocked
    },
}
