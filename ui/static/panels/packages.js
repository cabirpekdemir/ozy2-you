  ...
  const PACKAGES = [
    {
      ...
      description: "Herkese açık temel AI asistan. Ücretsiz ve açık kaynak.",
      price: "Ücretsiz",
      cta: "Şu an kullanıyorsunuz",
      ctaDisabled: true,
      features: [
        { icon: "💬", text: "AI Sohbet (Gemini / GPT / Claude)" },
        { icon: "✅", text: "Görevler & Hatırlatıcılar" },
        { icon: "🧠", text: "Hafıza & Notlar" },
        { icon: "📧", text: "Gmail & Takvim entegrasyonu" },
        { icon: "📱", text: "Telegram botu" },
        { icon: "📚", text: "Kitaplık & Özet" },
        { icon: "📰", text: "Günlük Briefing" },
        { icon: "🌤", text: "Hava durumu, haberler, döviz" },
      ],
    },
    {
      key: "professional",
      ...
      description: "Geliştirici ve profesyoneller için üretkenlik araçları.",
      price: "$9.99 / ay",
      cta: "Erişim İste",
      ctaDisabled: false,
      features: [
        { icon: "🐙", text: "GitHub entegrasyonu (repo arama, issue takibi)" },
        { icon: "☁️", text: "Google Drive yönetimi" },
        { icon: "📝", text: "Notion & Obsidian bağlantısı" },
        { icon: "📋", text: "Trello pano yönetimi" },
        { icon: "🗂️", text: "Proje planlayıcı" },
        { icon: "🎓", text: "Ders planı oluşturucu" },
        { icon: "🗣️", text: "Tartışma asistanı (Debate)" },
        { icon: "🖥️", text: "Workspace entegrasyonu" },
      ],
    },
    {
      key: "social",
      ...
      description: "Sosyal medya, yaratıcı içerik ve yaşam tarzı özellikleri.",
      price: "$9.99 / ay",
      cta: "Erişim İste",
      ctaDisabled: false,
      features: [
        { icon: "▶️", text: "YouTube analiz & özet" },
        { icon: "📱", text: "WhatsApp entegrasyonu" },
        { icon: "📈", text: "Borsa & kripto takibi" },
        { icon: "✍️", text: "İçerik üretici (blog, sosyal medya)" },
        { icon: "🏠", text: "Akıllı ev kontrolü" },
        { icon: "🎵", text: "Müzik & medya önerileri" },
        { icon: "📊", text: "Kişisel analytics" },
        { icon: "🔔", text: "Sosyal medya bildirimleri" },
      ],
    },
    {
      key: "business",
      ...
      description: "Ekipler ve kurumsal kullanım için gelişmiş iş araçları.",
      price: "$19.99 / ay",
      cta: "İletişime Geç",
      ctaDisabled: false,
      features: [
        { icon: "📊", text: "İş analitiği dashboard" },
        { icon: "🧾", text: "Fatura & muhasebe" },
        { icon: "👥", text: "Ekip yönetimi & roller" },
        { icon: "💼", text: "Jira / Linear / Asana" },
        { icon: "💬", text: "Slack & Microsoft Teams" },
        { icon: "🤝", text: "HubSpot CRM entegrasyonu" },
        { icon: "🎥", text: "Toplantı asistanı (meeting notes)" },
        { icon: "⚡", text: "Tüm Professional + Social özellikler" },
      ],
    },
    {
      key: "full",
      ...
      description: "Sınırsız erişim — tüm paketler dahil, öncelikli destek.",
      price: "Fiyat görüşme",
      cta: "Teklif Al",
      ctaDisabled: false,
      features: [
        { icon: "♾️", text: "Tüm YOU + PRO + SOCIAL + BUSINESS" },
        { icon: "🚀", text: "Öncelikli model erişimi (GPT-4o, Gemini Ultra)" },
        { icon: "🔌", text: "Özel skill marketplace erişimi" },
        { icon: "🛡️", text: "Öncelikli destek & SLA" },
        { icon: "🏗️", text: "Özel entegrasyon geliştirme" },
        { icon: "📦", text: "Self-hosted / on-premise seçeneği" },
        { icon: "🎛️", text: "Gelişmiş otomasyon (n iş akışı)" },
        { icon: "📈", text: "Kullanım analitiği & raporlama" },
      ],
    },
  ];
